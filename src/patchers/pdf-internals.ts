...
export const patchPDFInternals = async (plugin: PDFReader, pdfViewerComponent: PDFViewerComponent): Promise<boolean> => {
        ...
        load(old) {
            return async function (this: PDFViewerChild, ...args: any[]) {
                    ...
                    const onPointerUp = (evt: PointerEvent) => {
                        ...
                        if (this.palette?.selectedColorName !== undefined) {
                            if (evt.win.getSelection()?.toString()) {
                                this.palette.applyColorToSelection(this.palette.selectedColorName);
                            ...
                            if (plugin.settings.showSelectionToolbarOnMouseUp || isModEvent) {
                                if (evt.win.getSelection()?.toString()) {
                                    if (this.component && !this.selectionToolbar) {
                                        this.selectionToolbar = this.component.addChild(new SelectionToolbar(plugin, this));
                                    }
                                    evt.win.setTimeout(() => this.selectionToolbar?.show(evt), 80);
                ...
                const addColorPaletteToToolbar = () => {
                    try {
                        if (this.toolbar) {
                            plugin.domManager.addChild(new PDFReaderToolbar(plugin, this.toolbar, this));
                        } else {
            ...
            return async function (this: PDFViewerChild, file: TFile, subpath?: string) {
                ...
                if (file.stat.size < 300) {
                    ...
                    if (redirectTo) {
                        ...
                        this.pdfViewer.pdfReaderRedirect = { from: redirectFrom, to: redirectTo };
                ...
                lib.registerPDFEvent('annotationlayerrendered', this.pdfViewer.eventBus, this.component!, (data) => {
                    ...
                    pageView.annotationLayer?.div
                        ...
                        .forEach((el) => {
                            ...
                            if (annot.container.dataset.pdfReaderIsAnnotationPostProcessed === 'true') return;
                            ...
                            annot.container.dataset.pdfReaderIsAnnotationPostProcessed = 'true';
                        });
                });
                ...
                if (subpath) {
                    ...
                    const { dest, highlight } = ((subpath) => {
                        ...
                        if (!dest) {
                            ...
                            } else if (!this.opts.isEmbed // We need exclude embeds-likes (https://github.com/RyotaUshio/obsidian-pdf-reader/issues/137)
        ...
        renderAnnotationPopup(old) {
            return function (this: PDFViewerChild, annotationElement: AnnotationElement, ...args: any[]) {
                ...
                const modifyAnnotationPopup = (popupMetaEl: HTMLElement) => {
                    popupMetaEl.createDiv('pdf-reader-annotation-icon-container', (iconContainerEl) => {
                        ...
                        if (copyButtonEl) {
                            ...
                            iconContainerEl.createDiv('clickable-icon pdf-reader-copy-annotation-link', (iconEl) => {
                        ...
                        if (lib.isEditable(this)
                            ...
                            iconContainerEl.createDiv('clickable-icon pdf-reader-edit-annotation', (editButtonEl) => {
                        ...
                        if (lib.isEditable(child) && plugin.settings.enableAnnotationDeletion) {
                            iconContainerEl.createDiv('clickable-icon pdf-reader-delete-annotation', (deleteButtonEl) => {
