...
export class PDFOutlines {
    ...
    static async processOutlineRoot(process: (root: PDFOutlineItem) => void, file: TFile, plugin: PDFReader) {
        const { app } = plugin;
    ...
    static async findAndProcessOutlineItem(item: PDFOutlineTreeNode, processor: (item: PDFOutlineItem) => void, file: TFile, plugin: PDFReader) {
        const { app } = plugin;
