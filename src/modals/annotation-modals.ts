...
export class PDFAnnotationEditModal extends PDFAnnotationModal {
    ...
    async writeNewValues() {
        ...
        //                                 // lib.composer.linkUpdater.updateLinkColor(
        //                                 //     cache.refCache,
        //                                 //     cache.sourcePath,
        //                                 //     { type: 'rgb', rgb },
        //                                 //     { linktext: false }
        ...
        // if (writers.length) {
        //     await pdflibAPI.processAnnotation(this.file, this.page, this.id, async (annot: PDFDict) => {
...
export class PDFAnnotationDeleteModal extends PDFAnnotationModal {
    ...
    deleteAnnotation() {
        ...
        new Notice('Annotation deletion is currently disabled.');
    }
}
