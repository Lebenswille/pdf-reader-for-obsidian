    ...
    onOpen() {
        ...
        this.modalEl.createDiv('', (div) => {
            new Setting(div).setDesc(createFragment((el) => {
                ...
                el.createEl('a', { text: 'Learn more about dummy PDF files', href: 'https://ryotaushio.github.io/obsidian-pdf-reader/external-pdf-files' });
            }));
            setTimeout(() => {
    ...
    addFolderSetting() {
        return this.addSetting()
            ...
            .setDesc(createFragment((el) => {
                ...
                el.createEl('a', { text: 'settings', href: 'obsidian://pdf-reader?setting=dummyFileFolderPath' });
                el.appendText('.');
            }))
            .addText((text) => {
