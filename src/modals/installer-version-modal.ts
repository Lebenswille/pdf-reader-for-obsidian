...
// See https://github.com/RyotaUshio/obsidian-pdf-reader/issues/395#issuecomment-2680378913
const minInstallerVersion = "1.6.5";

export class InstallerVersionModal extends PDFReaderModal {
	static openIfNecessary(plugin: PDFReader) {
	...
	onOpen() {
		...
		this.contentEl.createDiv("modal-button-container", (el) => {
			...
			const helpUrl =
				"https://help.obsidian.md/Getting+started/Update+Obsidian#Installer%20updates";
			new ButtonComponent(el)
