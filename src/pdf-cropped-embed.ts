...
export class PDFCroppedEmbed extends Component implements Embed {
    ...
    // https://github.com/RyotaUshio/obsidian-pdf-reader/issues/397
    ...
    constructor(public plugin: PDFReader, public ctx: EmbedContext, public file: TFile, public subpath: string, public pageNumber: number, public rect: Rect, public width?: number, public annotationId?: string) {
        super();
        this.app = ctx.app;
